...
for i, (input, target) in progress_bar:
    ...
    utils.save_image(lr, os.path.join(
        "test", "SRGAN", str(opt.upscale_factor) + "x" + str(opt.upscale_factor) + "x", "SRGAN_" + str(i + 1) + "_lr.bmp"))
    utils.save_image(hr, os.path.join(
        "test", "SRGAN", str(opt.upscale_factor) + "x" + str(opt.upscale_factor) + "x", "SRGAN_" + str(i + 1) + "_hr.bmp"))
    utils.save_image(sr, os.path.join(
        "test", "SRGAN", str(opt.upscale_factor) + "x" + str(opt.upscale_factor) + "x", "SRGAN_" + str(i + 1) + "_sr.bmp"))
...
print("\n=== Performance summary SRGAN (upsampling x" + str(opt.upscale_factor) + "x" + str(opt.upscale_factor) + ")" + "\n" +
